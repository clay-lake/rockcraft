...
"""HUOPart metadata and configuration helpers."""
...
from craft_parts import PartSpec


class HUOPart:
    """Handles the HUOPart metadata information and setup operations."""

    HUOPART_PART_SPEC = {
        "plugin": "nil",
        # We need this because "services" is Optional, but the directory must exist
        "overlay": ["*"],
        "overlay-script": "touch test",
    }

    def define_hidden_part(
        self,
    ) -> str:
        return PartSpec.unmarshall(self.HUOPART_PART_SPEC)
